...
## Zweck
zentrale Release-Gates, Agentenrollen, Quellenpflicht und No-Go-Regeln. Ziel ist ein konservativer, dokumentierter, anwaltlich/ZFU-freigabefähiger Prüfrahmen vor jedem Launch.
...
alle öffentlichen Seiten, Checkout, Login, Worker, Service Worker, Content-Storage, Support-Flows.
