...
## Zweck
WCAG-nahe Nutzbarkeit, Shop/Login/App/Legal-Seiten, mobile Bedienung. Ziel ist ein konservativer, dokumentierter, anwaltlich/ZFU-freigabefähiger Prüfrahmen vor jedem Launch.
...
landing.html, login.html, index.html, legal pages, CSS/JS modals.
