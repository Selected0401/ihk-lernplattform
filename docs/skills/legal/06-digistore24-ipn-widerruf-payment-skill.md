...
## Zweck
Payment-Flow, IPN-Signatur, Idempotenz, Refund/Revocation, Lizenzcodes. Ziel ist ein konservativer, dokumentierter, anwaltlich/ZFU-freigabefähiger Prüfrahmen vor jedem Launch.
...
sales-config.js, cloudflare-worker/src/worker.js, ACCESS_CODE_SETUP.md, DIGISTORE24_COPY.md.
