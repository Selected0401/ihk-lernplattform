# IHK/Urheberrecht/Content Skill
...
## Zweck
IHK-Markennennung, eigene Aufgaben, keine Originalunterlagen, Content-Rechte. Ziel ist ein konservativer, dokumentierter, anwaltlich/ZFU-freigabefähiger Prüfrahmen vor jedem Launch.
...
landing.html, index.html, data/*.json, docs, Marketingseiten.
